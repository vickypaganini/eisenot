...
maxPlayers = 200
motd = "Welcome to The New-Styller Server!"
onePlayerOnlinePerAccount = true
allowClones = false
allowWalkthrough = true
serverName = "New-Styller"
statusTimeout = 5000
...
-- MySQL
mysqlHost = "108.174.144.200"
mysqlUser = "eisenot"
mysqlPass = "test123"
mysqlDatabase = "eisenot"
mysqlPort = 3306
mysqlSock = ""
...
experienceStages = {
	{ minlevel = 1, maxlevel = 50, multiplier = 400 },
	{ minlevel = 51, maxlevel = 100, multiplier = 200 },
	{ minlevel = 101, maxlevel = 150, multiplier = 100 },
	{ minlevel = 151, maxlevel = 200, multiplier = 50 },
	{ minlevel = 201, maxlevel = 250, multiplier = 20 },
	{ minlevel = 251, maxlevel = 300, multiplier = 5 },
	{ minlevel = 301, maxlevel = 350, multiplier = 1.7 },
	{ minlevel = 351, maxlevel = 400, multiplier = 1.5 },
	{ minlevel = 401, maxlevel = 500, multiplier = 1 },
	{ minlevel = 501, multiplier = 0.5 }
}
