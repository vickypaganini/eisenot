local inquisitionReward = {8854, 8855, 8858, 8849, 7451, 8931, 8925, 8929}
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if player:getStorageValue(Storage.inquisition) == 9 then
	...
	if player:addItem(item.uid, 1) then
		...
		player:setStorageValue(Storage.inquisition, 9)
	end
