local config = {
	...
	summons = {
		[8288] = {
			[5] = {'Demon', 'Ferumbras', 'Undead Dragon', 'Demon'},
			[10] = {'Undead Dragon', 'Ferumbras'}
		},
		[8289] = {
			[5] = {'Orshabaal', 'Sea Serpent Ice', 'Black Warlock'},
			[10] = {'Ferumbras', 'Morgaroth'}
		},
		[8290] = {
			[5] = {'Ferumbras', 'Ferumbras', 'Demon'},
			[10] = {'Morgaroth'}
		},
		[8291] = {
			[5] = {'Ferumbras', 'Ferumbras', 'Morgaroth'},
			[10] = {'Morgaroth', 'Undead Dragon'}
		}
	},
	storages = {
