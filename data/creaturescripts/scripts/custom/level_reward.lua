...
local config = {
	[{1,5}] = {
		...
		[20] = {type = "item", id = {2160, 2}, msg = "Congratulations, you have reached level 20 and received 10000 gold coins."},
		...
		[50] = {type = "item", id = {2160, 10}, msg = "Congratulations, you have reached level 100K."}
	...
	[{4,8}] = {
		...
		[70] = {type = "item", id = {2160, 10}, msg = "Congratulations, you have reached level 100K."}
	}
}
